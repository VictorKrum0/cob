...
KNN_params = {'n_neighbors' : list(range(3)),
              'weights' : ['uniform', 'distance'],
              'p' : [1,2,3]}

KNN_GS = GridSearchCV(KNeighborsClassifier(), KNN_params, n_jobs=-1, cv=10, scoring='accuracy')
KNN_GS.fit(knn_X_train, y_train) # X is train samples and y is the corresponding labels

#PART 2.2 : XGB

XGB_params = {
        'max_depth': [2,3,4,5,6,7,8,9,10,15,20,25,30,50],
...
MLP_params = {
        'hidden_layer_sizes': [(100,),(1000,),(100,100),(1000,1000),(20,20,20),(64,128,64)],
        'solver': ['sgd', 'adam'],
